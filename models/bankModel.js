...
class bankModel {
  ...
  insertDetails = async (data) => {
    let sql = `INSERT INTO admin_bank(user_id,bank_account_holder_name,bank_name,branchName,AccountNumber,ifsc_code,crypto_address,type)VALUES('${data.user_id}','${data.bank_account_holder_name}','${data.bank_name}','${data.branchName}','${data.AccountNumber}','${data.ifsc_code}','${data.crypto_address}','${data.type}')`;
    const [result, fields] = await promisePool.query(sql);
    return result;
  };
