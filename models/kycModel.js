...
class kycModel {
  ...
  updatePaymentModule = async (user_id, depositFiat) => {
    let sql = `UPDATE users SET depositFiat = ${depositFiat == '' ? null : depositFiat} WHERE id='${user_id}'`;
    console.log(sql);
    const [result, fields] = await promisePool.query(sql);
    return result;
  };
  ...
  updateUserBtcaddress = async (user_id,  depositCrypto) => {
    let sql = `UPDATE users SET btc_address = ${depositCrypto == '' ? null : depositCrypto} WHERE id='${user_id}'`;
    console.log(sql);
    const [result, fields] = await promisePool.query(sql);
    return result;
  };
  ...
  updateUserEthaddress = async (user_id,  depositCrypto) => {
    let sql = `UPDATE users SET eth_address = ${depositCrypto == '' ? null : depositCrypto} WHERE id='${user_id}'`;
    console.log(sql);
    const [result, fields] = await promisePool.query(sql);
    return result;
  };

  updateUserUsdtaddress = async (user_id,  depositCrypto) => {
    let sql = `UPDATE users SET usdt_address = ${depositCrypto == '' ? null : depositCrypto} WHERE id='${user_id}'`;
    console.log(sql);
    const [result, fields] = await promisePool.query(sql);
    return result;
  };

  updateUserUsdcaddress = async (user_id,  depositCrypto) => {
    let sql = `UPDATE users SET usdc_address = ${depositCrypto == '' ? null : depositCrypto} WHERE id='${user_id}'`;
    console.log(sql);
    const [result, fields] = await promisePool.query(sql);
    return result;
  };
