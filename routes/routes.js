...
let transactionImage = upload.fields([{ name: "transaction_image", maxCount: 1 }]);
...
router.post("/getUsersDetailsById/", usercontroller.getUserdDetailById.bind());
...
//crypto value set
router.post("/getcryptovalue", exchangeController.getcryptovalue.bind());
router.post("/updatelivecryptovalue", exchangeController.updatelivecryptovalue.bind());
router.post("/updatecryptovalue", exchangeController.updatecryptovalue.bind());
...
router.post("/updateTransactionStatus", transactionImage, withdrawalcontroller.updateTransactionStatus.bind());
